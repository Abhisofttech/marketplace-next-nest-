...
const Profile = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.patch(`${process.env.NEXT_PUBLIC_BACKEND_URI}users/update-userInfo`, userData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-2">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Update Profile</h2>
